                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="p-5 border border-gray-200 lg:flex lg:justify-between lg:items-center">
                        ...
                        <div class="mt-5 lg:mt-0">
                            <a class="bg-indigo-500 p-3 text-sm uppercase font-bold text-white rounded-lg" href="#">See
                                Candidates</a>
                        </div>
                    </div>
                    @empty
                    <p class="text-center text-gray-600">There are no new notifications</p>
                    @endforelse
                </div>
            </div>
        </div>
